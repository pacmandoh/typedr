...
Any <- as_assertion_factory(function(value, length = NULL) {
  if (!is_null(length) && length(value) != length) {
    ...
    .typedr_abort_assertion(c(
      "length mismatch",
      "x" = .typedr_compare(length(value), length, x_arg = "length(value)", y_arg = "expected")
    ))
  }
  value
})
...
Logical <- as_assertion_factory(function(value, length = NULL, null_ok = FALSE) {
  ...
  if (!is_logical(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "logical", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  if (!is_null(length) && length(value) != length) {
    length <- as.integer(length)
...
Integer <- as_assertion_factory(function(value, length = NULL, null_ok = FALSE) {
  ...
  if (!is_integer(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "integer", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  if (!is_null(length) && length(value) != length) {
    length <- as.integer(length)
...
Double <- as_assertion_factory(function(value, length = NULL, null_ok = FALSE) {
  ...
  if (!is_double(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "double", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  if (!is_null(length) && length(value) != length) {
    length <- as.integer(length)
...
Character <- as_assertion_factory(function(value, length = NULL, null_ok = FALSE) {
  ...
  if (!is_character(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "character", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  if (!is_null(length) && length(value) != length) {
    length <- as.integer(length)
...
Raw <- as_assertion_factory(function(value, length = NULL, null_ok = FALSE) {
  ...
  if (!is_raw(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "raw", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  if (!is_null(length) && length(value) != length) {
    length <- as.integer(length)
...
List <- as_assertion_factory(function(value, length = NULL, each, data_frame_ok = TRUE, null_ok = FALSE) {
  ...
  if (!is_list(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "list", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  if (!is_null(length) && length(value) != length) {
    length <- as.integer(length)
  ...
  if (!data_frame_ok && is.data.frame(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(is.data.frame(value), FALSE, x_arg = "is.data.frame(value)", y_arg = "expected")
    ))
  }
  value
})
...
Null <- as_assertion_factory(function(value) {
  if (!is_null(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "NULL", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  value
})
...
Closure <- as_assertion_factory(function(value, null_ok = FALSE) {
  ...
  if (typeof(value) != "closure") {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "closure", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  value
})
...
Special <- as_assertion_factory(function(value, null_ok = FALSE) {
  ...
  if (typeof(value) != "special") {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "special", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  value
})
...
Builtin <- as_assertion_factory(function(value, null_ok = FALSE) {
  ...
  if (typeof(value) != "builtin") {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "builtin", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  value
})
...
Environment <- as_assertion_factory(function(value, null_ok = FALSE) {
  ...
  if (!is_environment(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "environment", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  value
})
...
Symbol <- as_assertion_factory(function(value, null_ok = FALSE) {
  ...
  if (!is_symbol(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "symbol", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  value
})
...
Pairlist <- as_assertion_factory(function(value, length = NULL, each, null_ok = TRUE) {
  ...
  if (!is_pairlist(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "pairlist", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  if (!is_missing(each)) {
    nms <- names2(value)
...
Language <- as_assertion_factory(function(value, null_ok = FALSE) {
  ...
  if (typeof(value) != "language") {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "language", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  value
})
...
Expression <- as_assertion_factory(function(value, length = NULL, null_ok = FALSE) {
  ...
  if (typeof(value) != "expression") {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(typeof(value), "expression", x_arg = "typeof(value)", y_arg = "expected")
    ))
  }
  if (!is_null(length) && length(value) != length) {
    length <- as.integer(length)
...
Function <- as_assertion_factory(function(value, null_ok = FALSE) {
  ...
  if (!is_function(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(is_function(value), TRUE, x_arg = "is_function(value)", y_arg = "expected")
    ))
  }
  value
})
...
Factor <- as_assertion_factory(function(value, length = NULL, levels, null_ok = FALSE) {
  ...
  if (!is.factor(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(is.factor(value), TRUE, x_arg = "is.factor(value)", y_arg = "expected")
    ))
  }
  if (!is_null(length) && length(value) != length) {
    length <- as.integer(length)
  ...
  if (!is_missing(levels) && !identical(levels(value), levels)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(levels(value), levels, x_arg = "levels(value)", y_arg = "expected")
    ))
  }
  value
})
...
Data.frame <- as_assertion_factory(function(value, nrow, ncol, each, null_ok = FALSE) {
  ...
  if (!is.data.frame(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(class(value), "data.frame", x_arg = "class(value)", y_arg = "expected to contain")
    ))
  }
  if (!is_missing(nrow) && nrow(value) != nrow) {
    ...
    .typedr_abort_assertion(c(
      "Row number mismatch",
      "x" = .typedr_compare(nrow(value), nrow, x_arg = "nrow(value)", y_arg = "expected")
    ))
  }
  if (!is_missing(ncol) && ncol(value) != ncol) {
    ...
    .typedr_abort_assertion(c(
      ...
      "x" = .typedr_compare(ncol(value), ncol, x_arg = "ncol(value)", y_arg = "expected")
    ))
  }
...
Matrix <- as_assertion_factory(function(value, nrow, ncol, null_ok = FALSE) {
  ...
  if (!is.matrix(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(class(value), "matrix", x_arg = "class(value)", y_arg = "expected to contain")
    ))
  }
  if (!is_missing(nrow) && nrow(value) != nrow) {
    nrow <- as.integer(nrow)
...
Array <- as_assertion_factory(function(value, dim, null_ok = FALSE) {
  ...
  if (!is.array(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(is.array(value), TRUE, x_arg = "is.array(value)", y_arg = "expected")
    ))
  }
  if (!is_missing(dim) && !identical(dim(value), as.integer(dim))) {
    ...
    .typedr_abort_assertion(c(
      "dimension mismatch",
      "x" = .typedr_compare(dim(value), dim, x_arg = "dim(value)", y_arg = "expected")
    ))
  }
  value
})
...
Date <- as_assertion_factory(function(value, length = NULL, null_ok = FALSE) {
  ...
  if (!"Date" %in% class(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(class(value), "Date", x_arg = "class(value)", y_arg = "expected to contain")
    ))
  }
...
Time <- as_assertion_factory(function(value, length = NULL, null_ok = FALSE) {
  ...
  if (!"POSIXct" %in% class(value)) {
    .typedr_abort_assertion(c(
      "type mismatch",
      "x" = .typedr_compare(class(value), "POSIXct", x_arg = "class(value)", y_arg = "expected to contain")
    ))
  }
